  ...
  return (
    <div className=" shrink-0 h-full w-[300px] bg-yellow-400 rounded-xl p-5">
        ...
        <div className="flex justify-between mt-4" >
            <button className = "bg-green-500 py-1 px-3 text-sm border-r-4 border-b-4 border-2 rounded-xl m-1">
                Mark as Completed
            </button>
            <button className = "bg-red-500 py-1 px-3 text-sm border-r-4 border-b-4 border-2 rounded-xl m-1">
                Mark as Failed
            </button>
        </div>
